...
public:
	...
	std::vector<AkUniqueID> objectList;						// a list to track each instance of this plugin
	...
	std::vector<AkReal32> priorityList;						// used for calculating min and max Priority.  Not necessary to know which Priority belongs to which object.
	...
	void addToObjectList(AkUniqueID objectID);				// only allows 1 plugin instance per object to be listed
