...
#ifndef AutoCompressorConfig_H
#define AutoCompressorConfig_H
...
namespace AutoCompressorConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 8145;
}

#endif // AutoCompressorConfig_H
