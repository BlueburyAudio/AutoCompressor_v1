...
class AutoCompressorPlugin final
    : public AK::Wwise::Plugin::AudioPlugin
{
public:
    AutoCompressorPlugin();
    ~AutoCompressorPlugin();
...
DECLARE_AUDIOPLUGIN_CONTAINER(AutoCompressor);	// Exposes our PluginContainer structure that contains the info for our plugin
