...
#ifndef AutoCompressorFX_H
#define AutoCompressorFX_H
...
private:
    AutoCompressorFXParams* m_pParams;
    ...
    AkUInt32 sampleRate;
    AkReal32 epsilon = static_cast<AkReal32>(powf(10,-6));
