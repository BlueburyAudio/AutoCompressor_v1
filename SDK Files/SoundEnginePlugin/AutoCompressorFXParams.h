...
#ifndef AutoCompressorFXParams_H
#define AutoCompressorFXParams_H
...
static const AkPluginParamID PARAM_PRIORITY_ID = 1;
...
struct AutoCompressorFXParams
    : public AK::IAkPluginParam
{
    AutoCompressorFXParams();
    AutoCompressorFXParams(const AutoCompressorFXParams& in_rParams);
    ...
    AutoCompressorRTPCParams RTPC;
    AutoCompressorNonRTPCParams NonRTPC;
};

#endif // AutoCompressorFXParams_H
